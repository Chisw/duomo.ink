    ...
    <>
      ...
      >
        <Center innerClassName="pb-24">
          {!loaded ? (
            <div className="py-8 text-gray-500 leading-loose text-center">
              <img src={logo} alt="logo" className="inline-block m-4 w-16 h-16" />
              <p>合抱之木，生于毫末</p>
              <p>九层之台，起于累土</p>
              <p>千里之行，始于足下</p>
              <p className="text-gray-900">万斛之学，积于滴墨</p>
              <Button icon="tint" text="装载墨库" className="mt-8" onClick={() => setLoaded(true)} />
            </div>
          ) : (
            <ZI
              data={{
